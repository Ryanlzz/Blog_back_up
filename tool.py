...
def compress_photo():
    '''调用压缩图片的函数
    '''
    src_dir, des_dir = "./source/photos/photos/", "./source/photos/min_photos/"
...
def handle_photo():
    ...
    with open("G:/Git/Ryanlzz.github.io/source/photos/data.json","w") as fp:
